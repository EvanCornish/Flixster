...
<img src='https://github.com/EvanCornish/Flixster/blob/master/FlixsterGIF.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

I encountered difficulties with the YouTube trailer functionality and ended up running out of time to implement it.
